...
//  testHandleGeminiAnswerIssueSelectionForSprint();

  testHandleGeminiAnswerIssuesPriorities();
  testHandleGeminiAnswerIssuesEstimates();
...
const handleGeminiAnswerRefinementAdvice = (answer) => {
...
const testHandleGeminiAnswerRefinementAdvice = () => {
  // not object
  console.log(handleGeminiAnswerRefinementAdvice(" ").ok); // false
  console.log(handleGeminiAnswerRefinementAdvice(" efr").ok); // false

  console.log(handleGeminiAnswerRefinementAdvice("{}").ok); // false
  console.log(handleGeminiAnswerRefinementAdvice(JSON.stringify({
    action: "SOME_UNKNOWN_ACTION"
  })).ok); // false

  /* SPLIT */
  console.log("\nSPLIT");
  console.log("1\t" + handleGeminiAnswerRefinementAdvice(JSON.stringify({
    action: "SPLIT"
  })).ok); // false
  console.log("2\t" + handleGeminiAnswerRefinementAdvice(JSON.stringify({
    action: "SPLIT",
    parts: "string"
  })).ok); // false
  console.log("3\t" + handleGeminiAnswerRefinementAdvice(JSON.stringify({
    action: "SPLIT",
    parts: []
  })).ok); // false
  console.log("4\t" + handleGeminiAnswerRefinementAdvice(JSON.stringify({
    action: "SPLIT",
    parts: [
      {
        summary: 1,
  ...
  console.log("5\t" + handleGeminiAnswerRefinementAdvice(JSON.stringify({
    action: "SPLIT",
    parts: [
      {
        summary: "s1",
...
const handleGeminiAnswerIssueSelectionForSprint = (answer) => {
  // parse text generated by Gemini
  try{
    const obj = JSON.parse(answer);
    ...
    for (const arrItem of obj){
      if(checkFieldsValidity(arrItem, necessaryFields)){ // check if each expected field is present and has correct type
        selectedIssues.push(arrItem);
      }
      // otherwise, do not include current arrItem in result
    }

    return {ok: true, answer: selectedIssues};
  }
...
const testHandleGeminiAnswerIssueSelectionForSprint = () => {
  // not object
  console.log("1\t" + handleGeminiAnswerIssueSelectionForSprint(" ").ok); // false
  console.log("2\t" + handleGeminiAnswerIssueSelectionForSprint(" efr").ok); // false

  console.log("3\t" + handleGeminiAnswerIssueSelectionForSprint("{}").ok); // false


  console.log("4\t" + JSON.stringify(handleGeminiAnswerIssueSelectionForSprint(JSON.stringify([
    {
      unknownField: 100
    }
  ])).answer)); // []
  ...
  console.log("5\t" + JSON.stringify(handleGeminiAnswerIssueSelectionForSprint(JSON.stringify([
    {
      id: 100
    }
  ])).answer)); // []

  console.log("6\t" + JSON.stringify(handleGeminiAnswerIssueSelectionForSprint(JSON.stringify([
    {
      id: "100"
    },
    {},
...
export const handleGeminiAnswerIssuesPriorities = (answer) => {
  ...
  try {
    ...
    let necessaryFields = [
      ...
      {field: "priorityId", type: "string"}
    ];
    let validItems = [];
    for (const arrItem of obj) {
      if (checkFieldsValidity(arrItem, necessaryFields)) { // check if each expected field is present and has correct type
        validItems.push(arrItem);
      }
      // otherwise, do not include current arrItem in result
    }

    return {ok: true, answer: validItems};
  } catch (e) { // if result.answer is not an object
    return {ok: false, errorMessage: 'Something wrong happened. Try again.'};
  }
}
...
const testHandleGeminiAnswerIssuesPriorities = () => {
  // not object
  console.log("1\t" + handleGeminiAnswerIssuesPriorities(" ").ok); // false
  console.log("2\t" + handleGeminiAnswerIssuesPriorities(" efr").ok); // false

  // not array
  console.log("3\t" + handleGeminiAnswerIssuesPriorities("{}").ok); // false


  // array
  console.log("4\t" + JSON.stringify(handleGeminiAnswerIssuesPriorities(JSON.stringify([])).answer)); // []
  console.log("5\t" + JSON.stringify(handleGeminiAnswerIssuesPriorities(JSON.stringify([
    {
      unknownField: 100
    }
  ])).answer)); // []
  console.log("6\t" + JSON.stringify(handleGeminiAnswerIssuesPriorities(JSON.stringify([
    {
      userStoryId: 100
    },
    {
  ...
  ])).answer)); // [{userStoryId:'100', priorityId: '1000'}]
}




export const handleGeminiAnswerIssuesEstimates = (answer) => {
...
const testHandleGeminiAnswerIssuesEstimates = () => {
  // not object
  console.log("1\t" + handleGeminiAnswerIssuesEstimates(" ").ok); // false
  console.log("2\t" + handleGeminiAnswerIssuesEstimates(" efr").ok); // false

  // not array
  console.log("3\t" + handleGeminiAnswerIssuesEstimates("{}").ok); // false


  // array
  console.log("4\t" + JSON.stringify(handleGeminiAnswerIssuesEstimates(JSON.stringify([])).answer)); // []
  console.log("5\t" + JSON.stringify(handleGeminiAnswerIssuesEstimates(JSON.stringify([
    {
      unknownField: 100
    }
  ])).answer)); // []
  console.log("6\t" + JSON.stringify(handleGeminiAnswerIssuesEstimates(JSON.stringify([
    {
      userStoryId: 100
    },
    {
  ...
  ])).answer)); // [{userStoryId:'100', estimate: '1000'}]
}
